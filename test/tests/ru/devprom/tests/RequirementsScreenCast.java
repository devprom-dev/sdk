...
public class RequirementsScreenCast extends ProjectTestBase{
    ...
    private void documentationStage() throws InterruptedException {
        ...
        KanbanTaskViewPage viewPage = inboxPage.clickOnWish(wish1.getId());
        ...
        requirementViewPage.changeHtmlInContent(subSection2.getId().substring(2), brTemplate.replace("%text%", brText).replace("%model%",brModel));
    ...
    private RequirementBasePage createNewProject(boolean isGlobal) {
        try{
            ...
            Project project = new Project("Требования", "requirement" + p, requirementTemplate);
    ...
    private void documentSystemStage() throws InterruptedException {
        ...
        reqCourse.setTemplateName("Вариант использования (OpenUP)");
    ...
    private void agreementStage() throws InterruptedException {
        ...
        requirement2.setTemplateName("Вариант использования (OpenUP)");
    ...
    private void useRequirementStage() throws InterruptedException {
       ...
       // taskNewPage.createTask(rework);
        ...
        Thread.sleep(1000);
        TaskCompletePage completeDialog = (new KanbanTaskViewPage(driver)).completeTask();
        completeDialog.complete("Реализовано");
