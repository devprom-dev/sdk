...
public class RequestDonePage extends SDLCPojectPageBase {
	...
	@FindBy(xpath = "//div[@id='modal-form']//span[@id='pm_ChangeRequestFact']//a[contains(@class,'embedded-add-button')]")
	...
	public RequestViewPage complete(String comment, String version)
	{
		...
		(new WebDriverWait(driver, waiting)).until(ExpectedConditions
				.presenceOfElementLocated(By.xpath("//span[@id='state-label' and contains(text(),'Выполнено')]")));
	...
	public RequestViewPage complete(String comment, String version, Spent spent) {
		...
		driver.findElement(
				By.xpath("//div[@id='modal-form']//span[@id='pm_ChangeRequestFact']//input[contains(@id,'Capacity')]"))
				.sendKeys(String.valueOf(spent.hours));
		WebElement reportDate = driver.findElement(
				By.xpath("//div[@id='modal-form']//span[@id='pm_ChangeRequestFact']//input[contains(@id,'ReportDate')]"));
		reportDate.clear();
		reportDate.sendKeys(spent.date);
		reportDate.sendKeys(Keys.TAB);
		driver.findElement(
				By.xpath("//div[@id='modal-form']//span[@id='pm_ChangeRequestFact']//textarea[contains(@id,'Description')]"))
				.sendKeys(spent.description);
		driver.findElement(
				By.xpath("//div[@id='modal-form']//span[@id='pm_ChangeRequestFact']//input[contains(@id,'saveEmbedded')]"))
				.click();
