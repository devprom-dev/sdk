...
class ProjectWelcomeTable extends CoPageTable
{
    ...
    function getRenderParms( $parms )
    {
    	...
    	return array_merge(
    			...
    			array (
    					...
    					'custom_template_url' => 
    							'http://devprom.ru/features/%D0%A3%D0%BD%D0%B8%D1%84%D0%B8%D0%BA%D0%B0%D1%86%D0%B8%D1%8F-%D0%B8-%D0%BF%D0%BE%D0%B4%D0%B4%D0%B5%D1%80%D0%B6%D0%BA%D0%B0-%D0%BF%D1%80%D0%BE%D1%86%D0%B5%D1%81%D1%81%D0%BE%D0%B2-%D0%B2-%D0%BA%D0%BE%D0%BC%D0%BF%D0%B0%D0%BD%D0%B8%D0%B8'
    			)
    	);
    }
    ...
    function buildTiles()
    {
    	...
    	while( !$total_it->end() )
    	{
    		$tiles[] = array (
    				...
    				'name' => $total_it->getDisplayName(),
    				'description' => $total_it->get('Description'),
    				'id' => $total_it->getId(),
    ...
    {
    	if ( getSession()->getLanguage()->getLanguage() != 'RU' ) return array();
