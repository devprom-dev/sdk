...
# Security
    ...
    'security.login.password.prompt' => 'Пароль',
    'security.login.password.recover' => 'Забыли пароль?',
...
# Password resetting
    ...
    'resetting.password_already_requested' => 'Пароль для данного пользователя уже запрашивался за последние 24 часа. Пожалуйста, проверьте Ваш почтовый ящик.',
    'resetting.check_email' => 'На адрес %email% отправлено письмо. Оно содержит ссылку, при переходе по которой Вы сможете создать новый пароль.',
    'resetting.request.invalid_username' => 'Пользователь %username% не существует.',
    'resetting.request.username' => 'Email или Имя пользователя:',
