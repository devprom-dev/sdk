var tc = underi18n.MessageFactory({
    "scrumban-intro": "Scrum предназначен для получения релевантного результата путем периодической демонстрации промежуточных результатов. Kanban ориентирован на оперативное решение небольших задач. Если вам важно и то и другое - используйте Scrumban.</p><p> </p><p>1. Все задачи для команды собираются в общем бэклоге. Срочные и оперативные сразу попадают в работу и проходят все необходимые этапы производства.</p><p> </p><p>2. Крупные задачи преобразуются в эпики, которые в свою очередь декомпозируются на элементы бэклога. Владелец продукта устанавливает им приоритет и отвечает на уточняющие вопросы команды. Команда изучает и оценивает элементы бэклога. Приоритетные и понятные элементы бэклога планируются в ближайший спринт (итерацию).</p><p> </p><p>3. На этапе планирования команда распределяет внутри себя задачи, которые позволяют выполнить (реализовать) элементы бэклога. О возникающих трудностях, а также о текущем состоянии дел члены команды обмениваются на Scrum-митингах ежедневно. Владелец продукта должен быть всегда доступен для команды, чтобы дать важные уточнения, на возникающие вопросы.</p><p> </p><p>4. По завершении спринта команда демонстрирует результат владельцу продукта. Элементы бэклога требующие дополнительной работы возвращаются в бэклог. Команда старается непрерывно улучшать свои результаты путем проведения ретроспектив. На ретроспективах открыто говорят о проблемах в работе команды, способах их решения и конкретных шагах на этом пути.</p><p> </p><p>5. Производительность команды измеряется ее скоростью. Скорость команды позволяет прогнозировать сроки, в которые будут решены элементы бэклога. Измерение среднего времени цикла позволяет прогнозировать как быстро команда может решать срочные задачи.",
