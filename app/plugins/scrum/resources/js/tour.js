var tc = underi18n.MessageFactory({
    ...
    "scrum-planning": "В начале каждого <strong>спринта</strong> команда собирается на сессию планирования. Чтобы команда была <strong>сфокусирована </strong>на целях спринта, запишите их в описании спринта.</p><p>&nbsp;</p><p>Из бэклога выбираются самые <strong>приоритетные истории</strong>, уточняются требования, согласуются <strong>критерии приемки</strong> и фиксируются в тексте истории.</p><p>&nbsp;</p><p>Команда <strong>оценивает историю</strong> в <a href=\"http://devprom.ru/news/Как-Story-Points-соотносятся-с-часами\" target=\"_blank\">Story Points</a> или&nbsp;идеальных часах (способ оценки задается в настройках методологии проекта).</p><p>&nbsp;</p><p>Карточку переносят в состояние \"Запланировано в спринт\" и история&nbsp;<strong>декомпозируется</strong> на задачи, например, проектирование, разработка, тестирование и т.д.</p><p>&nbsp;</p><p>В спринт можно включить столько историй, сколько позволяет его <strong>емкость</strong>, определяемая начальной <strong>скоростью</strong> команды и продолжительностью спринта.",
    "scrum-grooming": "<strong>Груминг</strong> позволяет подготовить истории к планированию и сформировать roadmap на несколько ближайших спринтов.</p><p>&nbsp;</p><p>В течение текущего спринта участники команды изучают новые приоритетные истории, стараются их оценить и задают уточняющие вопросы в комментариях.</p><p>&nbsp;</p><p>На очередной сессии планирования команда работает с уже понятными историями, за счет чего сессии становятся короче и менее изнурительны.",
