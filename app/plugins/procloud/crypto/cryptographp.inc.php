...
// N'accepte que les fichiers de config du meme rйpertoire
...
// Vйrifie si l'utilisateur a le droit de (re)gйnйrer un cryptogramme
...
// Crйation du cryptogramme temporaire
...
// Crйation du cryptogramme dйfinitif
// Crйation du fond
    ...
    if ($charcolorrnd){   // Choisit des couleurs au hasard
       ...
       do {
          ...
          switch ($charcolorrndlevel) {
                 ...
                 case 4  : if ($rndcolor>650) $ok=true; break; // trиs claires
                 default : $ok=true;               
                 }
          } while (!$ok);
...
function noisecolor()
// Fonction permettant de dйterminer la couleur du bruit et la forme du pinceau
 {
...
function bruit()
// Ajout de bruits: point, lignes et cercles alйatoires
{
...
// Transformations supplйmentaires: Grayscale et Brouillage
// Vйrifie si la fonction existe dans la version PHP installйe
...
// Conversion du cryptogramme en Majuscule si insensibilitй а la casse
$word = ($difuplow?$word:strtoupper($word));


// Retourne 2 informations dans la session: 
// - Le code du cryptogramme (cryptй ou pas)
// - La Date/Heure de la crйation du cryptogramme au format integer "TimeStamp" 
