...
class DevpromJoinLicenseForm extends DevpromBaseForm
{
	...
	{
		return array ( 'Firstname', 'Email', 'Phone', 'Company', 'Possibilities', 'Captcha' );
	}
	...
	function draw()
	{
		echo '<div class="title">';
			echo 'Пожалуйста, аккуратно заполните все поля на форме, чтобы получить лицензионный ключ. ';
