...
{
    _gat._getTracker("UA-10541243-1")._trackEvent('demo-completed', devpromOpts.template, '');
    setTimeout(function() { window.location='https://projectscloud.ru/module/saasassist/create'; }, 200);
}
