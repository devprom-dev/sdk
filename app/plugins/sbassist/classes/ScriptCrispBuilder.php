...
class ScriptCrispBuilder extends ScriptBuilder
{
    ...
    public function build( ScriptRegistry & $object )
    {
        ...
        $object->addScriptFile(SERVER_ROOT_PATH."plugins/sbassist/resources/js/crisp.js");
        return;
    	...
    	$content = file_get_contents(SERVER_ROOT_PATH."plugins/sbassist/resources/js/crisp.js");
