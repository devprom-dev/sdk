...
include SERVER_ROOT_PATH."plugins/fileserver.php";
include SERVER_ROOT_PATH."plugins/iekworktable.php";
include SERVER_ROOT_PATH."plugins/kanban.php";
include SERVER_ROOT_PATH."plugins/saasassist.php";
...
include_once SERVER_ROOT_PATH."plugins/example1.php";
