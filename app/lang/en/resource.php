...
return array (
    'Оценка завершения' => 'Finish estimation',
    'Повторяющееся задание' => 'Recurring action',
    'Реестр' => 'Registry',
    ...
    'guide.mobile.app' => 'Mobile application',
    'guide.mobile.welcome' => 'Download and install Devprom ALM mobile application, then scan QR-code below to login',
    'guide.club' => 'Usage scenarios',
    'guide.support' => 'Ask for help',
    'guide.tour' => 'Product tour',
    'guide.process' => 'Process description',
    ...
    612 => 'Data was modified in other session already, please reload the page',
    ...
    734 => 'Common settings and methodology',
    ...
    1086 => 'An attribute with the same ReferenceName or Caption is defined for the entity already',
    ...
    1126 => 'Reference name may consits of letters, digits, underscore symbol',
    1127 => 'PHP settings',
    ...
    1200 => 'comment has been modified: %s',
    ...
    1311 => 'Summary',
    1312 => 'There are no items in the list to display, check the settings of the filter or import data.',
    ...
    2096 => 'Baseline has been persisted: %1',
    ...
    2167 => 'More details',
    2168 => 'work remained: %s hrs.<br/><a class="dashed" href="%s" target="_blank">more</a>',
    ...
    2182 => 'Assignee role',
    2183 => 'Setup the <a href="%1">list of values</a>.',
    2184 => 'Block reason',
    2185 => 'Delete later',
    ...
    2189 => 'available <span class="label">%s</span> &nbsp; planned <span class="%s">%s</span>',
    ...
    2218 => 'Specify a file you want to import, the following formats are supported: .html, .txt, .docx, .odt, .xls, .xlsx, .pdf',
    ...
    2282 => 'Specify document you want to import as issues. Text should be marked with heading styles. The following formats are supported .html, .txt, .rtf, .docx, .odt, .xls, .xlsx, .pdf',
    2283 => '%1 days',
    2284 => 'Average team velocity',
    2285 => 'API Key',
    2286 => 'Use the key to access REST API for example. Due to authorize just append the following HTTP header: "Devprom-Auth-Key: %s"',
    2287 => 'Project key',
    ...
    2321 => 'Display by submitting date',
    ...
    2474 => 'Estimated finish date of the project %2 is calculated based on <a href="%1">project plan</a>.',
    2475 => 'Workload',
    ...
    2684 => 'Save settings',
    2685 => '(planned: %s hrs, be available at %s)',
    2686 => 'Use latin symbols and digits to specify reference name. Reference name could be used to reference to the item.',
    2687 => 'ServiceDesk: issue view form',
    2688 => 'ServiceDesk: issues list',
    2689 => '<any value>',
    2690 => 'Reply-To address',
    2692 => 'Link to issue',
    2693 => 'Left volume',
    2694 => 'Add implementation',
    2695 => 'Incorrect state is specified',
    2696 => 'Nearest tasks reminder notification',
    2697 => 'Create enhancements based on requirements',
    2698 => 'Implements',
    2700 => '<p>More details <a target="_blank" href="%1">you\'ll find in docs</a></p>',
    2701 => 'Make suspected documenation for feature related',
    2702 => 'Linked feature has been enhanced',
    2750 => 'Set the state for all children pages',
    2751 => 'Set states of parent pages corresponding to children pages',
    2759 => 'Import from LDAP',
    2760 => 'Import of users and groups from LDAP server',
    2761 => 'Name and port number of LDAP server',
    2762 => 'Login name',
    2763 => 'Password',
    2764 => 'Unable to connect LDAP server using the address: %1 (%2)',
    2765 => 'Unable to authorize LDAP using the account: %1 (%2)',
    2766 => 'LDAP authorization has been completed successfully',
    2767 => 'Check directory objects you want to import. Already imported objects are bolded.',
    2768 => 'Unable to open the file for modification: %1',
    2769 => 'Directory search query',
    2770 => 'Root domain',
    2771 => 'Enter the LDAP server address and port number if required, e.g. company.com:389 (for Active Directory) or company.com:10389 (for ApacheDS)',
    2772 => 'Directory objects has been imported successfully',
    2773 => 'There are no object in the branch "%1" using the query "%2" (%3)',
    2774 => 'Unable to create group: there is no title for the object "%1"',
    2775 => 'User group has been created using the object "%1"',
    2776 => 'Unable to create user account: there is no login for the object "%1" (attribute in directory: %2)',
    2777 => 'Unable to create user account: there is no email address for the object "%1" (attribute in directory: %2)',
    2778 => 'User account has been created using the object "%1"',
    2779 => 'User "%1" has been joined the group "%2"',
    2780 => 'Import log',
    2781 => 'Create the task to update attributes of imported objects on periodically basis',
    2782 => 'LDAP: update attributes of imported objects',
    2783 => 'Import LDAP',
    2784 => 'SKIP: object "%1" is not group or user account',
    2785 => 'User account attributes of "%1" has been updated using the object "%2"',
    2786 => 'There are objects found in the branch "%1" using the query "%2": %3 (%4)',
    2787 => 'Windows integrated authentication',
    2788 => 'Mixed authorization: by password or integrated Windows authentication',
    2789 => 'There are no directory items to be imported',
    2797 => 'Enter user account name will be used to authorize into LDAP server, for example COMPANY\UserName',
    2799 => 'LDAP Import: assign common attributes',
    2800 => 'Attribute name corresponding to Windows account name',
    2801 => 'Attribute name corresponding to Email',
    2802 => 'LDAP directory type',
    2803 => 'Warning! Failed to read the contents of the log file, because logging is not set or is not activated. Please check the settings of logging in the file %1, make sure that the level of logging for the component %2 is set to INFO.',
    2804 => 'Internal comment',
    2805 => 'Open discussions',
    2806 => 'Closed discussions',
    2807 => 'All discussions',
    2809 => 'Log of interaction with LDAP-server',
    2810 => 'There is no permissions to create user (please check license restrictions)',
    2811 => 'Full access',
    2812 => 'All but delete',
    2813 => 'Quarter of change',
    2814 => 'Quarter of creation',
    2815 => 'Quarter of completion',
    2816 => 'Merge duplicates',
    2817 => 'Link together as duplicates',
    2818 => 'Merge into signle record, delete duplicates',
    2819 => 'Choose merge way',
    2820 => 'Choose target record',
    2821 => 'Request link type with system name "duplicates" was not found',
    2822 => 'Load more...',
    2823 => 'Decline related issue',
    2825 => 'Same enhancements',
    2826 => 'Text and traces were copied from %1',
    2827 => 'Traces were copied from %1',
    2828 => 'Text was used from %1',
    2829 => 'Unable to download file.',
    2830 => 'File is empty.',
    2831 => 'The following were not succeeded: %1',
    2832 => 'state changed',
    2833 => 'attributes changed',
    2834 => 'task created',
    2835 => 'comment created',
    2836 => 'Knowledge base pages',
    2837 => 'Master branch',
    2838 => 'Branches',
    2839 => 'Print (PDF)',
    2840 => 'Multiple selection is available',
    2841 => 'User or customer',
    2842 => 'Task types in progress',
    2843 => 'Enhancement type: %s',
    2844 => 'Dictionaries',
    2900 => 'All participants',
    2901 => '%s due to %s in project %s',
    2902 => 'Left tasks: %s, remaining hours: %s',
    2903 => 'It\' ok',
    2904 => 'Choose project',
    2905 => 'Open in registry',
    2906 => '%s: exists',
    2907 => '%s: none',
    2908 => 'Filter or search...',
    2909 => 'Spent hours per projects',
    2910 => 'Spent hours per tasks',
    2911 => 'Spent hours per participants',
    2912 => 'Spent hours per enhancements',
    2913 => 'Keys',
    2914 => 'Starting from',
    2915 => 'Till baseline',
    2916 => 'Cyclic dependency is found when linking tasks',
    2917 => 'Sort order',
    2918 => 'Color scheme',
    2919 => 'Visible columns',
    2920 => 'Attributes on cards',
    2921 => 'Content view settings',
    2922 => 'Show  UID',
    2923 => 'Show state',
    2924 => 'Number of visible sections',
    2925 => 'Dashboard',
    2926 => 'Add to dashboard',
    2927 => 'Metric value: %s',
    2928 => 'Reset attributes',
    2929 => 'Create branch',
    2930 => 'Open document',
    2931 => 'Allow to create artifacts using this state',
    2932 => 'Roadmap',
    2933 => 'Update are not available for this instance, please contact support@devprom.ru',
    2934 => 'View by default',
    2935 => 'Display section number',
    2936 => '(more than %s)',
    2937 => 'Previous baselines',
    2938 => 'Unable to find the file on path: %s',
    2939 => 'Visible on modification only',
    2940 => 'visible on modification',
    2941 => 'Create in %s',
    2942 => 'Copied from %s to %s',
    2943 => 'Copy to baseline',
    2944 => 'Choose attributes will be copied',
    2945 => 'Set state like parent has',
    2946 => 'Waiting for affirmation',
    2947 => 'Affirmed',
    2948 => 'Task state',
    2949 => 'Increment description',
    3000 => 'New',
    3001 => 'Open',
    3002 => 'Closed',
    3003 => 'My comments',
    3004 => 'Display open comments',
    3005 => 'Show comments',
    3006 => 'Reset cache',
    3007 => 'Increments templates',
    3008 => 'Navigation',
    3009 => 'Make project navigation is comfortable to you and your team',
    3010 => 'New issues',
    3011 => 'Add page identifier into section header',
    3012 => 'Export code of UML models and formulas',
    3013 => 'Move related artifact into the next state',
    3014 => 'Convert link to requirement inside description into fixed text',
    3015 => 'Increment state',
    3016 => 'Attribute "%s" cannot be modified',
    3017 => 'More details about texts templates settings read in <a href="%s" target="_blank">the docs</a>',
    3018 => 'Unknown role',
    3019 => 'Excluded from %s',
    3020 => 'Included into %s',
    3021 => 'Invalid data at row %s: %s',
    3022 => 'Change state for source issues',
    3023 => 'Implement in the project',
    3100 => 'Changes discarded were made on %s by %s',
    3101 => 'Recurring actions',
    3102 => 'Execution of Recurring actions',
    3103 => 'Recurring action "%s" has been completed',
    3104 => 'To adjust schedule for recurring actions use module <a href="%s" target="_blank">Recurring actions</a>',
    3105 => 'By schedule',
    3106 => 'Webhook log',
    3107 => 'Retries left',
    3108 => 'Task templates',
    3109 => 'Webhooks',
    3110 => 'Assigned tasks',
    3111 => 'List of tasks assigned to specified user',
    3112 => 'Assigned to me',
    3113 => 'Application',
    3114 => 'Visible for everyone',
    3115 => 'Assigned issues',
    3116 => 'Combination of values "%s" should be unique',
    3117 => 'It is required to specify watcher',
    3118 => 'Total efforts including tasks, derived requirements and enhancements',
    3119 => 'Was transition',
    3120 => 'Plan',
    3121 => 'from %s till %s',
    3122 => 'Start estimation %s, <span style="color:red">deviation is %s days</span>',
    3123 => 'PlantUML server address',
    3124 => 'MathJax server address',
    3125 => 'Left work by tasks',
    3126 => 'Other groups',
    3127 => 'Common issues board',
    3128 => 'Unknown project',
    3129 => 'System role of a user who is not a project participant',
    3130 => 'System role of a user who is participant of a program or a subproject',
    3131 => 'Development board',
    3132 => 'Move related issue into the state related to type of the next task',
    3133 => 'Section: %s',
    3134 => 'Spent time in the past',
    3135 => 'By priority',
    3136 => 'discussion is closed: %s',
    3137 => 'discussion is open: %s',
    3138 => 'System action was triggered: %s',
    3139 => 'System action "%s" was not executed, errors: %s',
    3140 => 'Consider the changes of %s',
    3141 => 'My tasks',
    3142 => 'Export parent nodes',
    3143 => 'Clear HTML-styles of document pages',
    3144 => 'Displayed in notifications',
    3200 => 'Form fields',
    3201 => 'Choose entity',
    3202 => 'You can change settings of fields using the module <a target="_blank" href="%s">Fields of forms</a> or append new fields using module <a target="_blank" href="%s">Attributes</a>',
    3203 => 'The list of all form fields settings can be found in <a target="_blank" href="%s">Fields settings</a> module',
    3204 => 'Is readonly',
    3205 => 'Work is assigned',
    3206 => 'Spent today',
    3207 => 'Any of words',
    3208 => 'All words',
    3209 => 'Exact phrase',
    3210 => 'External ID',
    3211 => 'Move related issue/increment in a state specified in parameters',
    3212 => 'Child appended: %s',
    3213 => 'Child excluded: %s',

    3300 => 'No answer',
    3301 => 'history',
    3302 => 'Current user is not author',
    3303 => 'To be reviewed',
    3304 => 'Requirements identity is not used',
    3305 => 'Working hours from 1m till %s hrs',
    3306 => 'Positive number',
    3307 => 'Bulleted lists template',
    3308 => 'Numbered lists template',
    3309 => 'The list contains work items that have a deadline at %s days',
    3310 => 'Notify user before action will be applied',
    3311 => 'Notify user',
    3312 => 'Attention. After the transition the following system actions will be applied:<br/><br/>%s',
    3313 => 'Component type',
    3314 => 'Component',
    3315 => 'Components list',
    3316 => 'Components',
    3317 => 'Components chart',
    3318 => 'Issues amount',
    3319 => '',
    3320 => 'ServiceDesk: product selection page',
    3321 => 'Estimation of project start %2 is calculated based on <a href="%1">project plan</a>',
    3322 => 'Project start',
    3323 => 'Project finish',
    3324 => 'Source code by tasks:'
);