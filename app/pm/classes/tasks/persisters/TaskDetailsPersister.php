...
class TaskDetailsPersister extends ObjectSQLPersister
{
 	function getSelectColumns( $alias )
 	{
 		...
 		$columns[] = " ( SELECT u.cms_UserId FROM cms_User u WHERE u.cms_UserId = t.Assignee AND u.PhotoPath IS NOT NULL) TaskAssigneePhotoId ";
 		
 		$columns[] = " ( SELECT u.Caption FROM cms_User u WHERE u.cms_UserId = t.Assignee AND u.PhotoPath IS NOT NULL) TaskAssigneePhotoTitle ";
