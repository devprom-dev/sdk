...
include_once SERVER_ROOT_PATH.'pm/classes/tasks/WorkItemState.php';
...
include_once SERVER_ROOT_PATH."pm/classes/common/DashboardItem.php";
...
include_once SERVER_ROOT_PATH."pm/classes/wiki/AffirmationState.php";
