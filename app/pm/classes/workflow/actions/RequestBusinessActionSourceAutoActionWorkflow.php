...
class RequestBusinessActionSourceAutoActionWorkflow extends BusinessActionWorkflow
{
	...
	function __construct( $action_it ) {
 	...
 	function getId() {
 		return $this->action_it->get('ReferenceName').'4sourceissue';
 	}

 	function getDisplayName() {
 		return text(2520).': '.$this->action_it->getDisplayName();
 	}
