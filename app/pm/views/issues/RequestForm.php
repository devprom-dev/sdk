...
class RequestForm extends PMPageForm
{
	...
	{
	    $this->methods = new RequestFormMethods($this->getObject(), $this->IsFormDisplayed());
    }
	...
	function createFieldObject( $name )
	{
		...
		{		
            ...
            case 'PlannedRelease':
                ...
                if ( $this->getAction() == 'view' ) {
                    $field = new FieldReferenceAttribute($this->getObjectIt(), $name,
                        getFactory()->getObject('Release'), $this->fieldActions[$name], true);
                    $field->setLovObject($release);
                    return $field;
                }
                else {
            ...
            case 'Iteration':
                ...
                if ( $this->getAction() == 'view' ) {
                    $field = new FieldReferenceAttribute($this->getObjectIt(), $name,
                        getFactory()->getObject('Iteration'), $this->fieldActions[$name], true);
                    $field->setLovObject($iteration);
                    return $field;
                }
                else {
	...
	function getDeleteActions()
	{
		...
		return $this->methods->getDeleteActions($object_it, $actions);
	}
    ...
    function getShortAttributes()
    {
        return array_merge(
            ...
            array('Priority', 'Estimation', 'Iteration', 'PlannedRelease', 'Owner', 'Tags', 'Severity', 'Environment', 'SubmittedVersion', 'LinkType')
        );
    }
