...
class PlanChartWidget extends FlotChartWidget
{
    ...
    public function __construct( $iterator, $start, $finish )
    {
        ...
        $this->projectStart = min($projectIt->fieldToArray('StartDate'));
        $this->projectFinish = max($projectIt->fieldToArray('FinishDate'));
    ...
    public function draw( $chart_id )
    {
        ...
        <script type="text/javascript">
            ...
            $(container).bind('scroll, mousewheel', function(e) {
                //e.stopPropagation();
            });
