...
include_once SERVER_ROOT_PATH.'/core/classes/caching/CacheEngineMemcached.php';


/**
 * @author Kosta Korenkov <7r0ggy@gmail.com>
 */
class CacheEngineMemcachedTest extends PHPUnit_Framework_TestCase {
    ...
    public function setUp() {
        ...
        $this->engine = new CacheEngineMemcached();
    }
