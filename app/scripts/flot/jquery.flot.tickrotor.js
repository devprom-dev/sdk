            ...
            if (!secondPass) {
                ...
                for (var i = 0; i < ticks.length; i++) {
                  ...
                  if (rotateTicks > 90) {
                    ...
                    if (rotateTicks > 90) {
                        ...
                        ticks[i].height =
                            Math.ceil(Math.sin(acuteRads) * tick.width)
                            + Math.ceil(Math.sin(acuteRads) * tick.height);
                    } else {
                        var acuteRads = Math.PI/2 - rotateTicksRads;
                        ticks[i].height =
                            Math.ceil(Math.sin(rotateTicksRads) * tick.width)
                            + Math.ceil(Math.sin(acuteRads) * tick.height);
                    }
                }
                ...
                for (var i = 0; i < ticks.length; i++) {
                    ...
                    if (rotateTicks <= 90) {
                        ...
                        ctx.translate(plot.getPlotOffset().left + xaxis.p2c(tick.v) + xoffset,
                                      box.top + box.padding + tick.height);
