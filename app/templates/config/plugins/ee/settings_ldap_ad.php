...
define('LDAP_DOMAIN', ''); 
define('LDAP_ROOTQUERY', '(|(objectClass=organizationalUnit)(objectClass=groupOfUniqueNames)(objectClass=organizationalPerson)(objectClass=group)(objectClass=person))'); 
define('LDAP_ATTRIBUTES', '' ); 
define('LDAP_GROUP_ATTR', 'cn' ); 
define('LDAP_TITLE_ATTR', 'cn' ); 
define('LDAP_NAME_ATTR', 'name' ); 
define('LDAP_LOGIN_ATTR', 'samaccountname' ); 
